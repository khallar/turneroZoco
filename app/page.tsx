    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-sm text-gray-500 mt-2">Conectando con Neon Serverless Postgres...</p> {/* Actualizado */}
        </div>
      </div>
    )
  }
        ...
        <div className="text-center mb-8">
          ...
          <div className="flex justify-center items-center gap-2 mb-4">
            ...
            <span className="text-sm text-gray-600">
              {error ? "Error de conexión" : isOnline ? "Conectado a Neon Serverless Postgres" : "Sin conexión"}{" "}
              {/* Actualizado */}
            </span>
          </div>
          ...
          <Card className="mb-6 bg-gray-50 border-gray-300">
            <CardHeader>
              <CardTitle className="text-sm flex items-center gap-2">
                ...
                Información de Debug - sistemaTurnosZOCO (Neon) {/* Actualizado */}
              </CardTitle>
            </CardHeader>
            <CardContent>
          ...
          >
            ...
            <span>
              {error
                ...
                : "Datos guardados en sistemaTurnosZOCO (Neon Serverless Postgres) - Persistencia garantizada"}{" "}
              {/* Actualizado */}
            </span>
          </div>
        </div>
      ...
      <footer className="text-center mt-8 text-gray-500 text-sm">
        ...
        <div className="mt-4 pt-4 border-t border-gray-200">
          <div className="text-center text-xs text-gray-400">
            <p>Develop by: Karim :) | Versión 4.0 | Powered by sistemaTurnosZOCO (Neon)</p> {/* Actualizado */}
          </div>
        </div>
      </footer>
    </div>
