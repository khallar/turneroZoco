...
import {
  ...
  COUNTER_KEY_PREFIX,
  limpiarDatosAntiguos, // Declare the variable here
} from "@/lib/database"
...
export async function POST(request: NextRequest) {
  try {
    ...
    if (action === "LIMPIAR_DATOS_ANTIGUOS") {
      try {
        // No es necesario pasar el estado completo a limpiarDatosAntiguos
        // ya que esta función opera directamente sobre las claves de Redis.
